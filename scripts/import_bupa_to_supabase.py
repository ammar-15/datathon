...
if not SUPABASE_URL or not SUPABASE_KEY:
    raise ValueError("Missing VITE_SUPABASE_URL or VITE_SUPABASE_ANON_KEY in .env")
...
def main() -> None:
    ...
    # optional safety check: avoid duplicate imports
    ...
    if existing_count > 0:
        ...
        confirm = input("Do you still want to insert all records again? (y/n): ").strip().lower()
        if confirm != "y":
            print("Import cancelled.")
            return

    batches = chunk_list(records, 100)
    inserted_total = 0
